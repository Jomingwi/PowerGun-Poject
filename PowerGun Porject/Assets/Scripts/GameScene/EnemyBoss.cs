...
public class EnemyBoss : MonoBehaviour
{
    ...
    public void difficultyHp(Difficulty difficulty)
    {
        ...
        if (difficulty == Difficulty.Hard) { bossMaxHp *= 1.5f; }
        bossCurHp = bossMaxHp;
    }
    ...
    void Update()
    {
        ...
        if (patternActive == false) { nextPattern(); }
    ...
    private void executePattern()
    {
        ...
        else if (curPattern == 3) { playerstun(); }
    ...
    {
        if (isGround == false || patternActive == true) { return; }
        isbossMoving = true;
